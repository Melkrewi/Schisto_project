...
#-# usage: qsub kallisto_index_jap.sh 
...
TRANSCRIPTOME="/nfs/scistore03/vicosgrp/mpicard/NEW_expressionanalysis/schistosoma_japonicum_CDS_Kallisto_17_11_2020.fasta" ;
OUF_INDEX="/nfs/scistore03/vicosgrp/mpicard/NEW_expressionanalysis/kallisto_index_japonicum";
